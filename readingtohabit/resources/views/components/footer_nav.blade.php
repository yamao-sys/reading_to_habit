<div class="footer_nav_area">
    <div class="footer_nav">
        ...
        <a class="footer_nav_content selected" href="{{\DocumentRootConst::DOCUMENT_ROOT}}articles">
            <div class="mb_2"><i class="fas fa-list color_primary"></i></div>
            <div class="char_color_primary">記録一覧</div>
        </a>
        @else
        <a class="footer_nav_content not_selected" href="{{\DocumentRootConst::DOCUMENT_ROOT}}articles">
        ...
        <a class="footer_nav_content selected" href="{{\DocumentRootConst::DOCUMENT_ROOT}}search_article_form">
            <div class="mb_2"><i class="fas fa-search color_primary"></i></div>
            <div class="char_color_primary">記録検索</div>
        </a>
        @else
        <a class="footer_nav_content not_selected" href="{{\DocumentRootConst::DOCUMENT_ROOT}}search_article_form">
        ...
        <a class="footer_nav_content selected" href="{{\DocumentRootConst::DOCUMENT_ROOT}}favorites">
            <div class="mb_2"><i class="fas fa-star color_primary"></i></div>
            <div class="char_color_primary">お気に入り</div>
        </a>
        @else
        <a class="footer_nav_content not_selected" href="{{\DocumentRootConst::DOCUMENT_ROOT}}favorites">
