...
class SearchResultsTest extends TestCase
{
    ...
    public function testSearchCondIntoSession1()
    {
        ...
        Article::withoutGlobalScopes()->where('id', 2)->first()->update(['bookname' => 'book2', 'author' => 'test software']);
        ...
        Article::withoutGlobalScopes()->where('id', 5)->first()->update(['bookname' => 'book5', 'author' => 'book5', 'mail' => 0]);
